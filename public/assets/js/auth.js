(() => {
  // --- Get config from config.js (with safe fallbacks) ---
  const CFG = (window.APP_CONFIG ?? {});
  const API_BASE = CFG.API_BASE || 'http://localhost:4000/api';
  const KEYS = Object.assign({ TOKEN: 'jwt', USER: 'user' }, CFG.STORAGE_KEYS || {});
